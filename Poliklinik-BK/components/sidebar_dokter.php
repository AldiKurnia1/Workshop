<aside class="flex flex-col w-[250px] h-[100vh] order-r-4 border-slate-600 pl-6 pr-8 py-10 sticky top-0">
        ...
        <div class="flex flex-col items-center gap-3">
            <img src="../../assets/images/doc.jpg" alt="" width="50px" class="rounded-full">
            <h1 class="text-lg text-black">Dokter</h1>
        </div>
        <!-- Profile End -->
        ...
        <div class="flex flex-col gap-5 mt-10">
            ...
            <a href="../../auth/logout.php"
                ...
                <h1 class="text-black font-medium">Log Out</h1>
            </a>
        </div>
        <!-- Menu End -->
    </aside>