...
<body class="flex gap-5 gradient-bg min-h-screen">
    ...
    <main class="flex flex-col w-full bg-white pb-10 px-8">
        <header class="flex items-center gap-3 py-6 mb-6 shadow-lg rounded-xl bg-[green] text-white">
        ...
        <article>
            ...
            <form action="" method="post" class="flex flex-col gap-5 mt-8 p-8 bg-white rounded-2xl shadow-md">
                <div class="flex flex-col gap-3">
                    <label for="nama_poli" class="text-lg font-medium text-[green]">Nama Poli</label>
                ...
                <div class="flex flex-col gap-3">
                    <label for="keterangan" class="text-lg font-medium text-[green]">Keterangan</label>
                    <input type="text" name="keterangan" id="keterangan" placeholder="Keterangan"
                        class="px-4 py-3 outline-none rounded-lg border border-[green]">
                </div>

                <button type="submit" name="submit"
                    class="bg-[green] w-fit py-3 px-6 text-white font-medium rounded-lg hover:bg-[green] transition-all">
                    Tambah Data
                </button>
            </form>
            ...
            <section class="mt-8 p-8 bg-white rounded-2xl shadow-md">
                <h1 class="mb-5 text-2xl font-medium text-[green]">Daftar Poli</h1>
                <table class="w-full table-fixed border border-black-500">
