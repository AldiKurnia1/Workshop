...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        <!-- Header -->
        <header class="flex items-center gap-3 px-8 py-7 bg-[green] text-white rounded-t-lg">
            <img src="../../assets/icons/notebook-pen.svg" alt="Doctor Icon" width="30px">
        ...
        <article class="px-8 py-5">
            <form action="" method="post" class="flex flex-col gap-5 bg-white p-8 shadow-lg rounded-lg">
                <h2 class="text-xl font-semibold text-[green]">Tambah Data Dokter</h2>
                ...
                <button type="submit" name="submit" class="bg-[green] py-3 px-6 text-white font-medium rounded-lg hover:bg-[green]">
                    Tambah Data
                </button>
            </form>
            ...
            <section class="mt-8 p-8 bg-white shadow-lg rounded-lg">
                <h2 class="mb-5 text-2xl font-medium text-[green]">Daftar Dokter</h2>
