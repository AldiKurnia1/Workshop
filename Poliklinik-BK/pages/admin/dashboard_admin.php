...
<body class="flex gap-5">
    ...
    <main class="grid grid-cols-2 gap-10 w-full p-10">
        ...
        <a href="kelola_dokter.php"
            class="card flex flex-col justify-center items-center bg-green p-10 rounded-lg shadow-lg hover:bg-[green] hover:text-white">
            <img src="../../assets/icons/notebook-pen.svg" alt="Dokter">
        ...
        <a href="kelola_pasien.php"
            class="card flex flex-col justify-center items-center bg-green p-10 rounded-lg shadow-lg hover:bg-[green] hover:text-white">
            <img src="../../assets/icons/pasien-icon.svg" alt="Pasien">
        ...
        <a href="kelola_poli.php"
            class="card flex flex-col justify-center items-center bg-green p-10 rounded-lg shadow-lg hover:bg-[green] hover:text-white">
            <img src="../../assets/icons/stethoscope-icon.svg" alt="Poli">
        ...
        <a href="kelola_obat.php"
            class="card flex flex-col justify-center items-center bg-green p-10 rounded-lg shadow-lg hover:bg-[green] hover:text-white">
            <img src="../../assets/icons/pill-icon.svg" alt="Obat">
