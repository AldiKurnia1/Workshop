...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        ...
        <article class="mx-8 mt-8 p-8 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl font-medium text-[green] mb-5">Daftar Riwayat Pasien</h2>
            <table class="w-full table-auto border border-gray-300">
                ...
                <tbody class="bg-white">
                    ...
                    <tr class="border-t">
                        ...
                        <td class="py-5 text-center">
                            <a href="detail_periksa.php?id=<?= $item["id"] ?>" class="bg-[green] px-6 py-2 rounded-lg text-white hover:bg-[green]">Detail</a>
                        </td>
                    </tr>
                    <?php $index++ ?>
                    <?php endforeach; ?>
