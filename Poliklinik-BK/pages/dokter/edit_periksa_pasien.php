...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        ...
        <article class="mx-8 mt-8 p-8 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl font-medium text-[green] mb-5">Edit Periksa Pasien</h2>
            <form action="" method="post" class="flex flex-col gap-5">
                ...
                <button type="submit" name="submit"
                    class="bg-[green] w-fit mx-auto py-3 px-6 text-white font-medium rounded-lg hover:bg-[green]">Simpan Perubahan</button>
            </form>
        </article>
    </main>
</body>
