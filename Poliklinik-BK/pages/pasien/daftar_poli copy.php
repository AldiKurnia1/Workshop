...
<body class="flex gap-5 bg-[green]">
    <!-- <script>
    ...
    <main class="flex flex-col w-full bg-[green] bg-white pb-10">
        ...
        <article class="flex gap-2 px-3">
            <div class="basis-[30%] mt-8 mx-5">
                <h1 class="bg-[green] px-5 py-4 text-white text-xl font-medium rounded-t-2xl">Daftar Poli</h1>
