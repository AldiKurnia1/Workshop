...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        <header class="flex items-center gap-3 px-8 py-7 bg-[green] rounded-t-lg shadow-lg">
            <img src="../../assets/icons/stethoscope-icon.svg" alt="Icon" width="30px" class="invert">
            <h1 class="text-3xl font-medium text-[white]">Daftar Poli</h1>
        </header>

        <article class="mx-8 mt-8 p-8 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl font-medium text-[green] mb-5">Langkah 1: Masukkan Informasi Anda</h2>
            <form action="" method="post" class="flex flex-col gap-5">
                <!-- Input Nomor Rekam Medis -->
                <div class="flex flex-col gap-3">
                    <label for="no_rm" class="text-lg font-medium text-[green]">Nomor Rekam Medis</label>
                    <input type="text" name="no_rm" id="no_rm" placeholder="Masukkan Nomor Rekam Medis"
                        class="px-4 py-3 outline-none rounded-lg border border-[green]">
                </div>

                <!-- Pilihan Poli -->
                <div class="flex flex-col gap-3">
                    <label for="poli" class="text-lg font-medium text-[green]">Pilih Poli</label>
                    <select id="poli" name="poli" class="px-4 py-3 outline-none rounded-lg border border-[green]">
                ...
                <button type="submit" name="submit"
                    class="bg-[green] w-full mx-auto py-3 px-6 text-white font-medium rounded-lg hover:bg-[green] transition duration-300">
                    Lanjut
                </button>
            </form>
        </article>
