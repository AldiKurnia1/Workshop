...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #d63921, #d63921);
        }
    </style>
</head>
...
<body class="flex h-screen">
    <figure class="basis-1/2 flex justify-center items-center h-full">
        <img src="../assets/images/klinik.png" alt="Illustration of Patient" width="60%">
    </figure>
    ...
    <main class="basis-1/2 relative flex justify-center items-center bg-white shadow-lg rounded-lg">
        ...
        <form action="" method="post" class="w-full px-20">
            <h1 class="text-center text-3xl font-semibold text-[green]">Login Pasien</h1>
            <div class="flex flex-col gap-5 mt-7">
                ...
                <button type="submit" name="login"
                    class="mt-3 bg-gradient-to-r from-[green] to-[green] text-white py-3 text-lg font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                    Login
                </button>

                <div class="flex justify-center gap-2 mt-4">
                    <h1 class="text-gray-600">Belum punya akun?</h1>
                    <a href="registrasi_pasien.php" class="text-[green] font-medium underline">Registrasi</a>
                </div>
            </div>
        </form>
    </main>
