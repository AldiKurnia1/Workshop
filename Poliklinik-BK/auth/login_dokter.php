...
<head>
    ...
    <style>
        /* Baby Blue Gradient */
        .gradient-bg {
            background: linear-gradient(135deg, #d63921, #d63921);
        }
...
<body class="flex h-screen gradient-bg">
    ...
    <figure class="w-1/2 flex justify-center items-center">
        <img src="../assets/images/klinik.png" alt="Doctor Illustration" class="max-w-full h-auto">
    </figure>
    ...
    <main class="w-1/2 flex justify-center items-center bg-white shadow-xl rounded-xl p-10">
        ...
        <form action="" method="post" class="w-full max-w-sm">
            <h1 class="text-center text-3xl font-semibold text-[green] mb-6">Login Dokter</h1>
            ...
            <button type="submit" name="login"
                class="w-full mt-6 bg-[green] text-white py-3 font-medium rounded-lg hover:bg-[green] transition-all">
                Login
            </button>
        </form>
    </main>
